  ...
  return (
    <span
      ...
      className={cn(
        ...
        showOnFocus && "invisible group-focus/dropdown-menu-item:visible group-focus/dropdown-menu-item:text-muted-foreground! group-focus/dropdown-menu-item:**:text-muted-foreground!",
        className,
      )}
      {...props}
    />
