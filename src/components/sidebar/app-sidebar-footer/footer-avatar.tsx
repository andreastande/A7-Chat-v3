...
export function FooterAvatar({ user }: { user?: User }) {
  if (!user) {
    return (
      <Avatar className="rounded-md group-data-[collapsible=icon]:group-[:hover,:focus,[data-state=open]]/menu-button:brightness-90 after:rounded-md">
  ...
  return (
    <Avatar className="rounded-md group-data-[collapsible=icon]:group-[:hover,:focus-visible,[data-popup-open]]/menu-button:brightness-90 after:rounded-md">
